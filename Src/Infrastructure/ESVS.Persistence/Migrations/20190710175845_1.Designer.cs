            ...
            modelBuilder.Entity("ESVS.Domain.Entities.Field", b =>
                {
                    ...
                    b.OwnsOne("System.Collections.Generic.HashSet<ESVS.Domain.ValueObjects.FieldValue>", "FieldValues", b1 =>
                        {
                            ...
                            b1.HasOne("ESVS.Domain.Entities.Field")
                                .WithOne("FieldValues")
                                .HasForeignKey("System.Collections.Generic.HashSet<ESVS.Domain.ValueObjects.FieldValue>", "FieldId")
                                .OnDelete(DeleteBehavior.Cascade);
                        });
                });
